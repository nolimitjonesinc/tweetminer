...
- Status Brain automation (self-documenting repo status)
...
- **Status Brain** — Auto-generates plain-English project status from git history and file structure — status-brain.mjs and .github/workflows/status-brain.yml
...
- Package dependencies not clearly defined (package.json not shown)
